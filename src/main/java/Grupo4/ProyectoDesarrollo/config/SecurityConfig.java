...
public class SecurityConfig {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                // Clínicas
                                                .requestMatchers(HttpMethod.GET, "/api/clinicas", "/api/clinicas/*")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.POST, "/api/clinicas")
                                                .hasRole("SUPER_ADMIN")
                                                .requestMatchers(HttpMethod.PUT, "/api/clinicas/*")
                                                .hasRole("SUPER_ADMIN")
                                                .requestMatchers(HttpMethod.DELETE, "/api/clinicas/*")
                                                .hasRole("SUPER_ADMIN")
                                                ...
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/medicos", "/api/medicos/*", "/api/especialidades",
                                                                "/api/especialidades/*",
                                                ...
                                                .requestMatchers(HttpMethod.POST,
                                                                "/api/medicos", "/api/especialidades",
                                                ...
                                                .requestMatchers(HttpMethod.GET,
                                                                ...
                                                                "/api/historia-clinica/*",
                                                                "/api/recetas", "/api/recetas/*", "/api/detalle-receta",
                                                                "/api/detalle-receta/*",
                                                                "/api/archivos", "/api/archivos/*", "/api/medicamentos",
                                                                "/api/medicamentos/*")
                                                .hasAnyRole("SUPER_ADMIN", "ADMIN_CLINICA", "MEDICO", "ENFERMERA",
                                                                "PACIENTE")
                                                .requestMatchers(HttpMethod.POST,
                                                                "/api/consulta-medica", "/api/historia-clinica",
                                                                "/api/recetas", "/api/detalle-receta",
                                                                "/api/archivos", "/api/medicamentos")
                                                .hasAnyRole("SUPER_ADMIN", "ADMIN_CLINICA", "MEDICO", "ENFERMERA")
                                                .requestMatchers(HttpMethod.PUT,
                                                                "/api/consulta-medica/*", "/api/historia-clinica/*",
                                                                "/api/recetas/*",
                                                                "/api/detalle-receta/*", "/api/archivos/*",
                                                                "/api/medicamentos/*")
                                                .hasAnyRole("SUPER_ADMIN", "ADMIN_CLINICA", "MEDICO", "ENFERMERA")
                                                .requestMatchers(HttpMethod.DELETE,
                                                                "/api/consulta-medica/*", "/api/historia-clinica/*",
                                                ...
                                                .requestMatchers("/api/facturas", "/api/facturas/*",
                                                                "/api/detalle-factura",
                                                                "/api/detalle-factura/*")
                                                .hasAnyRole("SUPER_ADMIN", "ADMIN_CLINICA", "PERSONAL_ADMINISTRATIVO",
                                                                "RECEPCIONISTA")

                                                // Reportes
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/reportes/ingresos", "/api/reportes/citas",
        ...
        public CorsConfigurationSource corsConfigurationSource() {
                ...
                configuration.setAllowedOrigins(
                                Arrays.asList("http://localhost:4200", "https://nova-salud-g.vercel.app",
                                                "https://frontend-desarrollo-web-integrado-g.vercel.app"));
