...
class HistoriaClinicaServicioTest {
    ...
    @InjectMocks
    private HistoriaClinicaServicioImpl service;
    ...
    void findAll() {
        ...
        List<HistoriaClinica> resultado = service.findAll();
    ...
    void save() {
        ...
        HistoriaClinica resultado = service.save(historia);
    ...
    void update() {
        ...
        HistoriaClinica resultado = service.update(1L, new HistoriaClinica());
